...
namespace frutas.Security
{
    ...
    /// Proporciona métodos para gestionar la sesión del usuario actual
    /// </summary>
    public static class SessionHelper
    {
        ...
        /// <summary>
        /// Actualiza la sesión con los datos más recientes del usuario
        /// </summary>
        /// <param name="usuario">DTO del usuario actualizado</param>
        ...
        /// </summary>
        /// <returns>True si la sesión ha expirado</returns>
        ...
        #region Métodos de información de request
        ...
        /// </summary>
        /// <returns>Información del navegador</returns>
        ...
        #region Métodos de validación de sesión
        ...
        /// <summary>
        /// Renueva la sesión actualizando el tiempo de login
        /// </summary>
        ...
        {
            if (!EstaLogueado) return "No hay sesión activa";

            var info = $"Usuario: {UsuarioActualUsername} (ID: {UsuarioActualId})\n" +
                      $"Rol: {UsuarioActualRol}\n" +
                      $"Tiempo de sesión: {TiempoSesion?.ToString(@"hh\:mm\:ss")}\n" +
                      $"IP: {ObtenerIPCliente()}\n" +
