...
namespace frutas.Repositories
{
    ...
    /// Implementa el patrón Repository con operaciones CRUD básicas
    /// </summary>
    ...
    public interface IRepository<T> where T : BaseEntity
    {
        ...
        IEnumerable<T> ObtenerPaginado(int pagina, int tamañoPagina);
        IEnumerable<T> ObtenerPaginado(int pagina, int tamañoPagina, Expression<Func<T, bool>> predicado);
        IEnumerable<T> ObtenerPaginadoOrdenado<TKey>(int pagina, int tamañoPagina, 
    ...
    /// Extiende IRepository con operaciones específicas para usuarios
    /// </summary>
    ...
    /// <summary>
    /// Interfaz específica para el repositorio de frutas
    /// Extiende IRepository con operaciones específicas para frutas
    /// </summary>
    ...
    /// <summary>
    /// Interfaz específica para el repositorio de logs
    ...
    public interface ILogRepository
    {
        ...
        // Paginación
        IEnumerable<Log> ObtenerPaginado(int pagina, int tamañoPagina);
        IEnumerable<Log> ObtenerPaginadoConFiltros(int pagina, int tamañoPagina, 
    ...
    /// <summary>
    /// Interfaz específica para el repositorio de API Keys
    /// </summary>
